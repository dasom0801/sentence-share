...
const ListModifyButton = ({
  ...
  const handleSenetenceModify = () => {
    const { author, bookImage, bookTitle, publisher, isbn, body } =
      sentenceItem;
  ...
  return (
    <div className='list-modify'>
      <button
        ...
        type='button'
        onClick={() => toggleModifyButton(!isModifyOpen, sentenceItem.id)}
      >

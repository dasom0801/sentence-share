...
const NavMenu = ({ changeLoginStatus, history, getUserLikesListDB, getUserSentenceListDB, userId }) => {
  const handleLogout = () => {
    // 사용자 로그아웃
  ...
  return ( 
    <div className="nav-menu">
      <ul>
        <li><NavLink to="/sentence" onClick={() => { getUserSentenceListDB({ userId, orderBy: 'updateDate' }) }}>내가 공유한 문장</NavLink></li>

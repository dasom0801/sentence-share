...
class DetailContainer extends Component {
  componentDidMount() {
    ...
    const filter =
      this.props.match.path.indexOf('/book') > -1 ? 'book' : 'user';
    // 쿼리에 사용할 책Id
  ...
  render() {
    return (
      <div>
        {this.props.match.path.indexOf('/book') > -1 ? (
...
//     },
//     changeDetailTab: (tab) => {
//       dispatch(actions.changeDetailTab(tab));
//     },
...
//     },
//     getSelectedUserInfoDB: (user) => {
//       dispatch(actions.getSelectedUserInfoDB(user));
//     },

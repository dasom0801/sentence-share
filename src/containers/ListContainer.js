...
//     },
//     getSentenceListFromDB: (orderBy, startItem) => {
//       dispatch(actions.getSentenceListFromDB(orderBy, startItem));
//     },
...
//     },
//     handleLikeClick: (index, id, likes, userId) => {
//       dispatch(actions.handleLikeClick(index, id, likes, userId));
//     },

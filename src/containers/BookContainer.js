...
class BookContainer extends Component {
  ...
  render() {
    ...
    return <Fragment>{printItem}</Fragment>;
  }
}
...
//     searchBookInfo: ({ keyword, bookSearchPage }) =>
//       dispatch(actions.searchBookInfo(keyword, bookSearchPage)),
//     selectBook: (book) => dispatch(actions.selectSearchedBook(book)),
//     showBookInfoInput: () => dispatch(actions.showBookInfoInput()),
//     changeBookInfoInput: (input) =>
//       dispatch(actions.changeBookInfoInput(input)),
...
//     getModifyItemDB: (sentenceId) =>
//       dispatch(actions.getModifyItemDB(sentenceId)),
//     changeLoadingStatus: (bool) => {
//       dispatch(actions.changeLoadingStatus(bool));
//     },
//     toggleModifyButton: (bool) => {
//       dispatch(actions.toggleModifyButton(bool));
//     },
//   };
// };
